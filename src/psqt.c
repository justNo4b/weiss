...
const int PieceSqValue[7][64] = {
    ...
    { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0),
      ...
      S(  5, 76), S( 27, 62), S( 40, 32), S( 33, -4), S( 48, -8), S( 96, 13), S( 47, 34), S( 16, 43),
      S( -3, 33), S( -3, 21), S(  2,  6), S( 24,-26), S( 32,-20), S( 36,-12), S(  4,  7), S( -2,  9),
      S(-14, 10), S(-14,  7), S( -3,-12), S(  1,-18), S(  8,-18), S(  5,-11), S( -5, -6), S(-14, -6),
      S(-18,  1), S(-23, -5), S(-18, -4), S(-11,-10), S( -5, -2), S( -6,  0), S( -1,-14), S( -9,-13),
      S( -8,  6), S(-13,  1), S(-15,  7), S( -6,  3), S(-11, 11), S( 12, 10), S( 15,-10), S(  1,-21),
      S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) },
    ...
    { S(-60,-67), S(-10,-10), S(-17, -6), S( -2, -7), S(  2, -1), S(-12, -5), S(-16,-16), S(-58,-47),
      ...
      S(  0, -6), S( 10,  9), S( 26, 31), S( 25, 41), S( 14, 48), S( 32, 29), S(  8, 21), S(  7,  3),
      S( -2, -2), S( 11,  6), S( 10, 35), S( 16, 40), S( 17, 35), S( 16, 35), S( 32,  8), S( 15, 10),
      S(-31,-31), S(-13,-16), S(-14,  2), S(  1, 20), S(  3, 17), S( -9, -2), S( -7,-12), S(-17,-24),
      S(-33,-19), S(-36,-12), S(-25,-27), S(-10, -6), S(-14, -6), S(-23,-27), S(-31, -6), S( -8, -8),
      S(-53,-57), S(-19,-41), S(-24,-27), S(-19, -7), S(-11, -8), S(-15,-21), S(-21,-23), S(-50,-43) },

    { S( -6,  4), S(  1,  0), S( -8,  8), S( -6,  7), S( -4,  7), S(-17, -1), S( -5,  5), S( -2,  0),
      S(-31,  0), S(  0, 14), S( -4, 11), S( -1,  9), S(  3,  9), S(  2, 10), S( -7, 10), S(-21,  1),
    ...
    { S( -2,  5), S( 10, 12), S( 24, 15), S( 21, 33), S( 27, 35), S( 27, 27), S( 10, 10), S( 23, 21),
      ...
      S(-15, -2), S( -3,-11), S( -7,  6), S(  8, 14), S( 35, 32), S( 57, 50), S( 64, 45), S( 40, 32),
      ...
      S(-18,-19), S( -8,-30), S(  4,-64), S(  0,-34), S(  3,-43), S( -8,-64), S(-13,-47), S(-20,-24),
    ...
    { S(-73,-51), S(-54,-27), S(-72,  6), S(-66, 20), S(-76,  5), S(-70,-25), S(-67,-15), S(-64,-67),
      ...
      S( -5,-93), S( 41,-79), S(  9,-49), S(-22,-56), S( -4,-85), S(-45,-44), S( 35,-80), S( 16,-151) },
};
