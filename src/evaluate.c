...
const int PawnPassed[8] = {
    ...
    S( 26, 81), S( 60,139), S(138,198), S(  0,  0),
};
...
const int KingLineDanger[28] = {
    S(  0,  0), S( -5, -2), S(-18,-25), S(-19, -8),
    S(-38,-11), S(-42,-22), S(-41,-24), S(-41,-20),
    S(-45,-18), S(-53,-17), S(-47,-20), S(-55,-13),
    S(-57,-14), S(-60,-12), S(-65,-13), S(-67,-11),
    S(-70,-15), S(-74,-20), S(-79,-23), S(-86,-32),
    S(-93,-34), S(-100,-44), S(-108,-53), S(-115,-68),
...
const int Mobility[4][28] = {
    // Knight (0-8)
    { S(-56,-54), S(-23,-68), S( -4,-22), S(  7, 15), S( 15, 30), S( 18, 50), S( 26, 53), S( 36, 49),
      S( 52, 28) },
    // Bishop (0-13)
    { S(-54,-98), S(-18,-94), S( -1,-37), S(  6, -4), S( 14, 14), S( 22, 38), S( 25, 54), S( 23, 61),
      S( 22, 70), S( 27, 70), S( 31, 68), S( 57, 53), S( 59, 68), S( 49, 50) },
    // Rook (0-14)
    { S(-59,-69), S(-27,-60), S(-12,-36), S(-11,-17), S( -5, 16), S( -2, 36), S( -3, 55), S(  2, 57),
      S(  9, 62), S( 17, 67), S( 26, 71), S( 29, 72), S( 29, 73), S( 43, 62), S( 89, 35) },
    // Queen (0-27)
    { S(-62,-48), S(-71,-36), S(-67,-49), S(-44,-50), S(-25,-47), S( -7,-45), S(  3,-37), S( 10,-23),
      S( 15, -7), S( 20, 10), S( 22, 25), S( 25, 35), S( 28, 41), S( 28, 50), S( 29, 56), S( 29, 64),
      S( 26, 70), S( 26, 71), S( 24, 75), S( 28, 73), S( 33, 75), S( 50, 63), S( 59, 68), S( 78, 65),
