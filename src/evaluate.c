...
const int PawnPassed[8] = {
    ...
    S( 26, 81), S( 60,139), S(137,197), S(  0,  0),
};

// (Semi) open file for rook and queen [pt-4]
const int OpenFile[2]     = { S( 28, 10), S( -9,  6) };
...
const int KingLineDanger[28] = {
    S(  0,  0), S( -5, -2), S(-17,-24), S(-19, -8),
    S(-37,-12), S(-41,-22), S(-40,-25), S(-41,-20),
    S(-44,-19), S(-53,-17), S(-46,-20), S(-54,-13),
    S(-57,-15), S(-60,-13), S(-66,-13), S(-67,-12),
    S(-71,-15), S(-75,-20), S(-80,-24), S(-87,-32),
    S(-94,-34), S(-101,-44), S(-109,-52), S(-115,-66),
    S(-121,-66), S(-126,-60), S(-130,-53), S(-135,-55),
};

// Mobility [pt-2][mobility]
const int Mobility[4][28] = {
    // Knight (0-8)
    { S(-57,-54), S(-23,-67), S( -3,-23), S(  7, 14), S( 15, 29), S( 18, 49), S( 26, 53), S( 36, 48),
      S( 51, 28) },
    // Bishop (0-13)
    { S(-55,-96), S(-19,-93), S( -1,-37), S(  6, -4), S( 14, 13), S( 21, 37), S( 25, 54), S( 23, 61),
      S( 22, 69), S( 27, 70), S( 31, 67), S( 58, 52), S( 59, 68), S( 49, 51) },
    // Rook (0-14)
    { S(-59,-69), S(-28,-59), S(-13,-35), S(-12,-17), S( -5, 15), S( -2, 35), S( -3, 55), S(  2, 57),
      S(  9, 61), S( 17, 66), S( 26, 71), S( 28, 71), S( 29, 73), S( 43, 62), S( 88, 35) },
    // Queen (0-27)
    { S(-62,-48), S(-70,-36), S(-67,-49), S(-45,-50), S(-26,-46), S( -8,-45), S(  3,-37), S( 10,-23),
      S( 15, -7), S( 19,  9), S( 22, 25), S( 25, 35), S( 28, 40), S( 28, 50), S( 29, 56), S( 28, 64),
      S( 26, 70), S( 26, 70), S( 24, 74), S( 28, 73), S( 34, 74), S( 50, 63), S( 59, 69), S( 79, 66),
